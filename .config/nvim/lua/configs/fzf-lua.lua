...
vim.keymap.set('n', '<Leader>fD', fzf.lsp_typedefs, { desc = 'Find LSP type definitions' })
vim.keymap.set('n', '<Leader>fd', fzf.lsp_definitions, { desc = 'Find LSP definitions' })
vim.keymap.set('n', '<Leader>fs', fzf.lsp_document_symbols, { desc = 'Find LSP document symbols' })
vim.keymap.set('n', '<Leader>fS', fzf.lsp_live_workspace_symbols, { desc = 'Find LSP workspace symbols' })
vim.keymap.set('n', '<Leader>fi', fzf.lsp_implementations, { desc = 'Find LSP implementations' })
