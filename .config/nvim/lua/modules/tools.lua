return {
  {
    ...
    keys = {
      ...
      { '<Leader>fe', desc = 'Find document diagnostics' },
      { '<Leader>fE', desc = 'Find workspace diagnostics' },
      ...
      { '<Leader>fD', desc = 'Find symbol type definitions' },
      { '<Leader>fd', desc = 'Find symbol definitions' },
      { '<Leader>fs', desc = 'Find symbol document symbols' },
      { '<Leader>fS', desc = 'Find symbol workspace symbols' },
      { '<Leader>fi', desc = 'Find symbol implementations' },
      { '<Leader>f<', desc = 'Find symbol incoming calls' },
      { '<Leader>f>', desc = 'Find symbol outgoing calls' },
      { '<Leader>fr', desc = 'Find symbol references' },
      { '<Leader>fR', desc = 'Find symbol locations' },
    },
    event = 'LspAttach',
    build = 'fzf --version',
    init = function()
