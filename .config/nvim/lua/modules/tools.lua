return {
  {
    ...
    keys = {
      ...
      { '<Leader>R', desc = 'Find LSP locations' },
      ...
      { '<Leader>fD', desc = 'Find LSP type definitions' },
      { '<Leader>fd', desc = 'Find LSP definitions' },
      { '<Leader>fs', desc = 'Find LSP document symbols' },
      { '<Leader>fS', desc = 'Find LSP workspace symbols' },
      { '<Leader>fi', desc = 'Find LSP implementations' },
      { '<Leader>f<', desc = 'Find LSP incoming calls' },
      { '<Leader>f>', desc = 'Find LSP outgoing calls' },
      { '<Leader>fr', desc = 'Find LSP references' },
      { '<Leader>fR', desc = 'Find LSP locations' },
    },
    event = 'LspAttach',
    build = 'fzf --version',
