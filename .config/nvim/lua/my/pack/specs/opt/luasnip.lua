    ...
    postload = function()
      ...
      local tabout = setmetatable({}, {
        __index = function(self, key)
          ...
          local has_tabout, tabout_plugin = pcall(require, 'my.plugin.tabout')
          if has_tabout then
      ...
      local function range_contains(range1, range2)
        return require('my.utils.lsp').range_contains(
      ...
      local function range_contains_cursor(range, cursor)
        return require('my.utils.lsp').range_contains_cursor(
          range_convert(range),
          cursor
        )
      end
