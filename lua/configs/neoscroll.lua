...
vim.keymap.set({ 'n', 'x' }, '<C-d>', function() nsc.ctrl_d({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<C-u>', function() nsc.ctrl_u({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<C-f>', function() nsc.ctrl_f({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<C-b>', function() nsc.ctrl_b({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<S-Up>', function() nsc.ctrl_b({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<S-Down>', function() nsc.ctrl_f({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<PageUp>', function() nsc.ctrl_b({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<PageDown>', function() nsc.ctrl_f({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<S-PageUp>', function() nsc.ctrl_b({ duration = scroll_duration() }) end)
vim.keymap.set({ 'n', 'x' }, '<S-PageDown>', function() nsc.ctrl_f({ duration = scroll_duration() }) end)
